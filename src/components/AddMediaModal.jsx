...
const AddMediaModal = ({ isOpen, onClose, onRefresh, editData }) => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      alert(
        "Arama yapılamadı. İnternet bağlantınızı veya API Key'i kontrol edin.",
      );
    } finally {
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-3 pt-4">
              <button
                type="button"
                onClick={onClose}
                className="flex-1 px-4 py-2 bg-gray-100 rounded-lg hover:bg-gray-200 text-gray-700 font-medium"
              >
                İptal
              </button>
              <button
                type="submit"
                disabled={loading}
                className="flex-1 px-4 py-2 text-white bg-blue-600 rounded-lg hover:bg-blue-700 disabled:opacity-50 font-medium shadow-lg shadow-blue-500/30"
              >
